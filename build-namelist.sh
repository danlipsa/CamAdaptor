...
#$camcfg/build-namelist -test -config $CAM_BUILD/config_cache.xml -namelist "&seq_timemgr_inparm stop_n=3 stop_option='nmonths' / &cam_inparm  nhtfrq=0, -24, -24, -24, -24, -24 mfilt=10,30,30,30,30,30 hfilename_spec='%c.cam.h%t.%y-%m-%d-%s.nc' print_step_cost=.true. / "
